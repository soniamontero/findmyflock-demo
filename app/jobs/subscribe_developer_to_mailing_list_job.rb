class SubscribeDeveloperToMailingListJob < ApplicationJob
  ...
  #   gibbon.lists(list_id).members.create(body: {email_address: developer.email, status: "subscribed", merge_fields: {FNAME: developer.first_name, LNAME: developer.last_name}})
  # end
